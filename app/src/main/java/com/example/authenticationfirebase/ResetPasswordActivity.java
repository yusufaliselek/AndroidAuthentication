                ...
                auth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(ResetPasswordActivity.this, "Emailinize Sıfırlama Bağlantısı Gönderildi!", Toast.LENGTH_SHORT).show();

                        }
                        else {
                            Toast.makeText(ResetPasswordActivity.this, "Hata!", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
